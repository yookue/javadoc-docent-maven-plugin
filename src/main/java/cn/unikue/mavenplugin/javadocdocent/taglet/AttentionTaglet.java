...
/**
 * A block taglet that representing {@code @attention} tag
 *
 * <pre><code>
 *     &#64;attention "content"
 * </code></pre>
 ...
 * <pre><code>
 *     &lt;dt&gt;
 *         &lt;span class="simpleTagLabel&gt;Attention:&lt;/span&gt;
 *     &lt;/dt&gt;
 *     &lt;dd&gt;
...
public class AttentionTaglet extends AbstractBlockTaglet {
    ...
    public String toString(@Nonnull List<? extends DocTree> tags, @Nonnull Element element) {
        ...
        String dtTitle = ResourceBundleUtils.getTagletMessage(super.getLocale(), "Taglet.attention", TAG_TITLE);    // $NON-NLS-1$
